...
| `**transaction.gasPrice**` | Gas price (legacy transactions) |
| `**transaction.maxFeePerGas**` | Max fee per gas (EIP-1559) |
| `**transaction.maxPriorityFeePerGas**` | Max priority fee (EIP-1559) |
| `**transaction.blockNumber**` | Block number |
| `**transaction.blockHash**` | Block hash |
| `**transaction.transactionIndex**` | Index in block |
| `**transaction.input**` | Transaction input data (hex) |
| `**transaction.type**` | Transaction type |
| `**receipt.blockNumber**` | Block number from receipt |
| `**receipt.blockHash**` | Block hash from receipt |
| `**receipt.gasUsed**` | Actual gas used |
| `**receipt.cumulativeGasUsed**` | Cumulative gas used in block |
| `**receipt.effectiveGasPrice**` | Effective gas price paid |
| `**receipt.status**` | Transaction status (1 = success) |
| `**receipt.contractAddress**` | Contract address (for deployments) |
| `**receipt.transactionIndex**` | Transaction index in block |

###### Stellar Variables
| **Variable** | **Description** |
| --- | --- |
| `**transaction.hash**` | Transaction hash |
| `**transaction.ledger**` | Ledger sequence number |
| `**transaction.ledgerCloseTime**` | Ledger close time |
| `**transaction.status**` | Transaction status |
| `**transaction.applicationOrder**` | Application order in ledger |
| `**ledger.sequence**` | Ledger sequence number |
| `**ledger.hash**` | Ledger hash |
| `**ledger.closeTime**` | Ledger close time |
...
| `**transaction.blockTime**` | Block time (if available) |
| `**block.slot**` | Block slot |
| `**block.blockhash**` | Block hash |
| `**block.parentSlot**` | Parent slot |
| `**block.blockTime**` | Block time (if available) |
| `**block.blockHeight**` | Block height (if available) |
