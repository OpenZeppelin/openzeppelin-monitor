...
* Now, you can also filter by parameters event's name (Stellar Protocol 23 has introduced this new feature). See <<stellar-event-parameter-access>> for more details
====
