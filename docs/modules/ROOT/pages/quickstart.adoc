...
[TIP]
====
You can find the contract's SEP-48 interface and function signatures by visiting the link:https://stellar.expert/explorer/public/contract/CA6PUJLBYKZKUEKLZJMKBZLEKP2OTHANDEOWSFF44FTSYLKQPIICCJBE?filter=interface[Stellar DEX Contract Interface^] on Stellar Expert.
====
