...
|arguments
|String
|The arguments of the script. The arguments are passed to the script as command line arguments. If you want to pass more than one argument, each argument should be separated by a comma.
