...
Slack, Discord, Telegram and Email support Markdown formatting in their message bodies. You can use Markdown syntax to enhance your notifications.
...
* Send notifications through each configured channel when matches are found
