...
For Stellar function `transfer(Address from, Address to, I128 amount)`:
[source,json]
----
{
...
You can find a contract's SEP-48 interface by visiting the contract on Stellar Expert and clicking on the "Interface" tab. For example:
link:https://stellar.expert/explorer/public/contract/CA6PUJLBYKZKUEKLZJMKBZLEKP2OTHANDEOWSFF44FTSYLKQPIICCJBE?filter=interface[Stellar DEX Contract Interface^]
====
