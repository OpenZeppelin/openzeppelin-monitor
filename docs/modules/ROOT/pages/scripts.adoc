= Custom scripts
:description: Documentation for the custom scripts implementation for filtering matches and handle custom notifications.

The OpenZeppelin Monitor includes the possibility of adding scripts to add extra filtering conditions to monitor matches and also to handle custom notifications.
