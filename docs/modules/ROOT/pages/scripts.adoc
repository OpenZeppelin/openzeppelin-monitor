...
* For more details about filters and scripts, see the sample implementations https://github.com/OpenZeppelin/openzeppelin-monitor/tree/main/examples/config/filters[here]
...
* For more details about scripts, see the sample implementations https://github.com/OpenZeppelin/openzeppelin-monitor/tree/main/examples/config/triggers/scripts[here]
