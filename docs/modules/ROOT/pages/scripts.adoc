...
* For more details about filters and scripts, see the sample implementations in the `examples/config/filters` directory
...
* For more details about scripts, see the sample implementations in the `examples/triggers/scripts` directory
