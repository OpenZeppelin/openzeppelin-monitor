...
* Use [Testing your configuration](/monitor/1.1.x#testing-your-configuration) (e.g. `--monitor-path` and `--network` / `--block`) to test against specific blocks.
* See the [Quickstart](/monitor/1.1.x/quickstart) and main [Configuration](/monitor/1.1.x#configuration-guidelines) docs for more options.
